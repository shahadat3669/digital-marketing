...
# 🎯 Digital Marketing<a name="about-project"></a>

> Hello creative people, Digital Marketing Landing Page is a modern template clean and Responsive HTML5/SCSS landing page. All files are clearly organized and each and every block of HTML and SCSS file is properly commented which will help you to customize this html project as per your requirements.
...
```bash
  git clone git@github.com:shahadat3669/digital-marketing.git
```
